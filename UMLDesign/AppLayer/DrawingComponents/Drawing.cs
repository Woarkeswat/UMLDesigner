...
namespace AppLayer.DrawingComponents
{
    ...
    public class Drawing
    {
        private static readonly DataContractJsonSerializer JsonSerializer =
                new DataContractJsonSerializer(typeof(List<Element>), new [] { typeof(Element), typeof(ClassDiagram), typeof(ClassDiagramWithAllState), typeof(ClassDiagramExtrinsicState), typeof(LabeledBox), typeof(Line) });
        ...
        public void LoadFromStream(Stream stream)
        {
            ...
            lock (_myLock)
            {
                ...
                {
                    var tmpTree = element as ClassDiagramWithAllState;
                    if (tmpTree != null)
                    {
                        ClassDiagram fullTree = ClassDiagramFactory.Instance.GetTree(tmpTree.ExtrinsicState);
