...
namespace AppLayer.DrawingComponents
{
    ...
    /// </summary>
    [DataContract]
    public class ClassDiagramWithAllState : ClassDiagram
    {
        public Pen OutlinePen { get; set; } = new Pen(Color.DarkGray);
        internal ClassDiagramWithIntrinsicState IntrinsicState { get; }

        [DataMember]
        public ClassDiagramExtrinsicState ExtrinsicState { get; set; }
        ...
        {
            return new ClassDiagramWithAllState(IntrinsicState, ExtrinsicState = ExtrinsicState.Clone());
        }
